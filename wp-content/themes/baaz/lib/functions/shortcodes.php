...
add_shortcode('url','cws_url_shortcode');

function cws_url_shortcode($atts) {
...
add_shortcode('wpurl','cws_wpurl_shortcode');

function cws_wpurl_shortcode($atts) {
...
add_shortcode('child', 'cws_child_shortcode');

function cws_child_shortcode($atts) {
...
// Closes a div
add_shortcode('end-div', 'cws_end_div_shortcode');

function cws_end_div_shortcode($atts) {
	return '</div>';
}