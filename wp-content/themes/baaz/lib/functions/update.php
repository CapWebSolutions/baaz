...
function update_notifier_menu() {
	...
	$ignore = genesis_get_option( 'cws_ignore_updates', 'baaz-settings' );
	if ( 1 == $ignore )
			return;
...
function get_latest_theme_version( $interval ) {
	...
	$notifier_file_url = 'https://www.web-savvy-marketing.com/files/theme-versions/baaz.xml';
