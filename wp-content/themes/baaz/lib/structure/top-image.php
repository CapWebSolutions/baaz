...
function richard_do_top_image() {
	...
	//default Image
	$page_default_image = genesis_get_option( 'cws_page_top_image', 'richard-settings' );
	$pa_default_image = genesis_get_option( 'cws_practice_area_top_image', 'richard-settings' );
	$attorney_default_image = genesis_get_option( 'cws_attorney_top_image', 'richard-settings' );
	...
	elseif ( is_singular('cws_practice-area') ) {
	...
	elseif ( is_singular('cws_attorney') ) {
