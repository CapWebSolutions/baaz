...
add_action( 'widgets_init', create_function( '', "register_widget('Cap_Web_Featured_Page');" ) );


class Cap_Web_Featured_Page extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'Displays featured page with thumbnails', 'baaz' ),
		);
		...
		parent::__construct( 'wsmfeatured-page', __( 'Cap Web - Featured Page', 'baaz' ), $widget_ops, $control_ops );
	...
	function widget( $args, $instance ) {
		 ...
		 * Filter strings for WPML translation
     	 */
     	$instance['title'] = apply_filters( 'wpml_translate_single_string', $instance['title'], 'Widgets', 'Cap Web - Featured Page - Widget Title' );
     	$instance['more_text'] = apply_filters( 'wpml_translate_single_string', $instance['more_text'], 'Widgets', 'Cap Web - Featured Page - More Text' );
     	$instance['custom_text'] = apply_filters( 'wpml_translate_single_string', $instance['custom_text'], 'Widgets', 'Cap Web - Featured Page - Custom Text' );
     	// WPML
	...
	function update( $new_instance, $old_instance ) {
		 ...
		 * register strings for translation
     	 */
	 	do_action( 'wpml_register_single_string', 'Widgets', 'Cap Web - Featured Page - Widget Title', $new_instance['title'] );
	 	do_action( 'wpml_register_single_string', 'Widgets', 'Cap Web - Featured Page - More Text', $new_instance['more_text'] );
	 	do_action( 'wpml_register_single_string', 'Widgets', 'Cap Web - Featured Page - Custom Text', $new_instance['custom_text'] );
	 	//WMPL
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'page_id' ); ?>"><?php _e( 'Page', 'baaz' ); ?>:</label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_title' ); ?>"><?php _e( 'Show Page Title', 'baaz' ); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_content' ); ?>"><?php _e( 'Show Page Content', 'baaz' ); ?></label>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'content_limit' ); ?>"><?php _e( 'Content Character Limit', 'baaz' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'more_text' ); ?>"><?php _e( 'More Text', 'baaz' ); ?>:</label>
