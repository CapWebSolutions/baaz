...
add_action( 'genesis_loop', 'baaz_attorneys_loop' );
function baaz_attorneys_loop() {
...
echo '<div class="attorneys-container">';
	...
	$attorneys_count = genesis_get_option( 'cws_attorneys_count', 'baaz-settings' );

	$query_args = array(
				'post_type' => 'cws_attorney',
	...
	$wp_query = new WP_Query( $query_args );
			...
			while ( $wp_query -> have_posts() ) :
						...
						$attorney_short_desc = get_post_meta( $post_id , '_baaz_attorney_short_desc', true );
						$attorney_job_title = get_post_meta( $post_id , '_baaz_attorney_job_title', true );
