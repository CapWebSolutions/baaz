...
add_action( 'genesis_after_loop', 'baaz_practice_area_loop' );
function baaz_practice_area_loop() {
...
echo '<div class="pa-container">';
	...
	$wp_query = new WP_Query( $query_args );
			...
			$cta_title = get_post_meta( $post->ID , '_baaz_pas_cta_title', true );
			$cta_content = get_post_meta( $post->ID , '_baaz_pas_cta_content', true );
			$cta_link = get_post_meta( $post->ID , '_baaz_pas_cta_link', true );
