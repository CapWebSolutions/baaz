...
add_action( 'genesis_loop', 'baaz_attorney_page' );
function baaz_attorney_page() {
...
$attorney_contact_heading = get_post_meta( $post_id , '_baaz_attorney_contact_heading', true );
$attorney_address = get_post_meta( $post_id , '_baaz_attorney_contact_address', true );
$attorney_phone = get_post_meta( $post_id , '_baaz_attorney_contact_phone', true );
$attorney_fax = get_post_meta( $post_id , '_baaz_attorney_contact_fax', true );
$attorney_email = get_post_meta( $post_id , '_baaz_attorney_contact_email', true );
$attorney_linkedin = get_post_meta( $post_id , '_baaz_attorney_contact_linkedin', true );
$attorney_facebook = get_post_meta( $post_id , '_baaz_attorney_contact_facebook', true );
$attorney_twitter = get_post_meta( $post_id , '_baaz_attorney_contact_twitter', true );
$attorney_gplus = get_post_meta( $post_id , '_baaz_attorney_contact_gplus', true );
...
$schools_heading = get_post_meta( $post_id , '_baaz_attorney_education_heading', true );
$schools = get_post_meta( $post_id , '_baaz_attorney_education_group', true );
...
foreach ( (array) $schools as $key => $school ) {
	...
	if ( isset( $school['_baaz_attorney_school_name'] ) )
	$school_name = strip_tags($school['_baaz_attorney_school_name']);
	if ( isset( $school['_baaz_attorney_school_desc'] ) )
	$school_desc = $school['_baaz_attorney_school_desc'];
...
$associations_heading = get_post_meta( $post_id , '_baaz_attorney_associations_heading', true );
$associations = get_post_meta( $post_id , '_baaz_attorney_associations_group', true );
...
foreach ( (array) $associations as $key => $association ) {
	...
	if ( isset( $association['_baaz_attorney_association_name'] ) )
	$association_name = strip_tags($association['_baaz_attorney_association_name']);
...
echo '<div class="attorney-content entry-content">';
	...
	$short_desc = get_post_meta( $post_id , '_baaz_attorney_short_desc', true );

	if ( $short_desc ) { echo '<div class="intro-text">' . $short_desc .'</div>'; }

	$industries = get_post_meta( $post_id , '_baaz_attorney_industry_group', true );
	$get_practice_areas = get_post_meta( $post_id , '_baaz_attorney_select_pa', true );

	// Practice Area

	$pa_heading = get_post_meta( $post_id , '_baaz_attorney_pa_heading', true );
	...
	// Industries
	$industries_heading = get_post_meta( $post_id , '_baaz_attorney_industries_heading', true );
	...
	foreach ( (array) $industries as $key => $industry ) {
		...
		if ( isset( $industry['_baaz_attorney_industry_name'] ) )
		$industry_name = strip_tags($industry['_baaz_attorney_industry_name']);
...
// Awards
	...
	$awards_heading = get_post_meta( $post_id , '_baaz_attorney_awards_heading', true );
	$awards = get_post_meta( $post_id , '_baaz_attorney_awards_group', true );
	...
	foreach ( (array) $awards as $key => $award ) {
		...
		if ( isset( $award['_baaz_attorney_award_logo'] ) )
		$award_logo = strip_tags($award['_baaz_attorney_award_logo']);
