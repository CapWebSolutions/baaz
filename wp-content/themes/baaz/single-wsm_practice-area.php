...
add_action( 'genesis_loop', 'baaz_practice_area_post' );
function baaz_practice_area_post() {
...
// Left Icon
	...
	$pa_icon = get_post_meta( $post_id , '_baaz_pa_featured_icon', true );
	$pa_icon_default = get_post_meta( $post_id , '_baaz_pa_featured_icon_default', true );
...
add_action( 'genesis_before_footer', 'baaz_bottom_featured', 5 );
function baaz_bottom_featured() {
...
$video_oembed = get_post_meta( $post_id , '_baaz_pa_video_oembed', true );
$video_poster = get_post_meta( $post_id , '_baaz_pa_video_poster', true );
$video_desc = get_post_meta( $post_id , '_baaz_pa_video_desc', true );
$video_title = get_post_meta( $post_id , '_baaz_pa_video_title', true );
...
$quote_text = get_post_meta( $post_id , '_baaz_pa_quote_text', true );
$quote_name = get_post_meta( $post_id , '_baaz_pa_quote_name', true );
$quote_company = get_post_meta( $post_id , '_baaz_pa_quote_company', true );
$quote_bg = get_post_meta( $post_id , '_baaz_pa_quote_bg', true );
